...
This animated graph shows ticket price and theatre capacity filled for every Broadway show 1985-2022.  ("Capacity filled" is the percentage of seats taken from the total seats available in a theatre)

All code for this project can be found [here](https://github.com/rachelheiss/broadway_project). 
